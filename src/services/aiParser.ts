...
- Для каждой задачи определи:
  - title: краткое название действия (до 80 символов, глагол + суть)
  - description: 1-2 предложения — что конкретно нужно сделать, зачем, контекст. ВСЕГДА заполняй, даже если задача простая. Не повторяй title дословно — расширяй смысл.
  - dueDate: дата исполнения в ISO формате YYYY-MM-DD или null
  - priority: high — срочные/важные, low — «когда-нибудь», medium — всё остальное
  - sourceText: исходный фрагмент текста из которого взята задача
...
Формат ответа:
{"tasks": [{"title": "...", "description": "...", "dueDate": "YYYY-MM-DD или null", "priority": "high|medium|low", "sourceText": "..."}]}`
